import { Guild, ShardClientUtil, TextChannel,
    ...
    InteractionDeferReplyOptions, WebhookEditMessageOptions, GuildChannel, SelectMenuInteraction
} from "discord.js";
...
class SelectMenuContext {
    ...
    values: SelectMenuInteraction["values"];

    constructor(client: typeof Client, interaction: SelectMenuInteraction) {
